...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">Tambah Spare Part</li>
@endsection
@section('content')
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('merk') is-invalid @enderror"
                                    id="merk" name="merk" value="{{ old('merk') }}" placeholder="Masukkan merk"
                                    required>
                                @error('merk')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('deskripsi') is-invalid @enderror" id="deskripsi" name="deskripsi" rows="3"
                                    placeholder="Masukkan deskripsi sparepart">{{ old('deskripsi') }}</textarea>
                                @error('deskripsi')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('stok') is-invalid @enderror"
                                    id="stok" name="stok" value="{{ old('stok', 0) }}" placeholder="Masukkan stok"
                                    required min="0">
                                @error('stok')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
